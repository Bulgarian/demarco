...
class Article extends \AppBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'slug', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'section', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'summary', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'authorEmail', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'publishedAt'];
        }
